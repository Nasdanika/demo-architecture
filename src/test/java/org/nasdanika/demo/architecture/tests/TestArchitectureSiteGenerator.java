package org.nasdanika.demo.architecture.tests;
...
import org.nasdanika.architecture.core.gen.ArchitectureSiteGenerator;
...
public class TestArchitectureSiteGenerator {
	...
	public void generate() throws Exception {
		...
		URI semanticModelURI = URI.createFileURI(new File("model/architecture.yml").getAbsolutePath());
		...
		ArchitectureSiteGenerator siteGenerator = new ArchitectureSiteGenerator() {
